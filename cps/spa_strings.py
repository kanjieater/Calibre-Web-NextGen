...
# Experimental Store / Discover — acquisition search, explicit work/edition
# selection, write-only per-user credentials, and the admin approval queue.
_("Store")
_("Store / Discover")
_("Store access")
_("Store downloads without approval")
_("Search external acquisition sources through a configured Shelfmark service.")
_("Experimental")
_("Developer preview")
_("Early features stay hidden until you enable them here. They may change or require additional services.")
_("Experimental settings saved.")
_("Could not load experimental features.")
_("Could not save experimental settings.")
_("No experimental features are registered.")
_("Find a work, then choose the exact edition you want.")
_("Search the Store")
_("Could not search the Store.")
_("The Store is not available right now.")
_("Choose the work")
_("Choose an edition")
_("Choose an edition to continue.")
_("Choose {title}")
_("Selected {title}")
_("Selected")
_("Select")
_("{count} matches")
_("Unknown author")
_("No matching works found.")
_("Release source")
_("Release details come from the acquisition source so you can verify format, size, and language.")
_("Could not load release sources.")
_("No release sources are enabled.")
_("Could not load editions.")
_("No editions found from this source.")
_("No additional edition details")
_("Download this edition")
_("Request this edition")
_("Download")
_("Request")
_("Sending…")
_("Download queued.")
_("Request sent for approval.")
_("Already queued.")
_("Could not queue this release.")
_("Active downloads")
_("Store download")
_("Download progress")
_("Retry {title}")
...
_("Pending")
_("Untitled request")
_("You have no pending requests.")
_("Could not load your requests.")
_("Provider credentials")
_("Your paid provider keys are encrypted in the server database. They are write-only here: neither you nor an administrator can reveal a saved key. Administrators can only revoke it.")
_("Configured · ending in {last4}")
_("Enter a replacement key")
_("Enter provider key")
_("Replace")
_("Credential saved.")
_("Credential revoked.")
_("Could not load credentials.")
_("Could not save credential.")
_("Could not revoke credential.")
_("Revoke {provider} credential")
_("Revoke the saved {provider} credential?")
_("Anna's Archive")
_("LibGen")
_("Z-Library")
_("welib")
...
_("IRC")
_("AudiobookBay")
_("Saved Store credentials are write-only. Administrators can revoke them but can never reveal or copy their values.")
_("Revoke the {provider} credential for {name}?")
_("Revoke {provider}")
_("Store requests")
_("Review the exact work and edition each user selected.")
_("Requested by {name}")
_("Unknown user")
_("Approve")
_("Reject")
...
_("Could not load Store requests.")
_("No Store requests are waiting.")
